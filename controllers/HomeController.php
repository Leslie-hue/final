...
class HomeController {
    ...
    private function validateContactForm() {
        ...
        if ($appointmentRequested) {
            ...
            if (empty($_POST['payment_method']) || !in_array($_POST['payment_method'], ['online', 'in_person'])) {
    ...
    private function addDailySlots() {
        try {
            ...
            $date = trim(filter_input(INPUT_POST, '极date', FILTER_SANITIZE_FULL_SPECIAL_CHARS));
