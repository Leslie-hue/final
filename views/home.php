...
<body>
        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-buttons">
                    ...
                    <a href="#services" class="btn btn-outline btn-lg" aria-label="Découvrir nos services"><i class="fas fa-gavel" aria-hidden="true"></i> Nos services</a>
                </div>
            </div>
        </div>
    </section>
                    ...
                    <form id="contactForm" method="POST" action="/contact" enctype="multipart/form-data">
                        ...
                        <div class="file-upload-section">
                            <div class="file-upload-header">
                                ...
                                <p>Glissez-déposez vos fichiers ici ou cliquez pour sélectionner (max: 10MB)</p>
                            ...
                            <div class="upload-info"><i class="fas fa-info-circle" aria-hidden="true"></i> Formats acceptés : PDF, DOC, DOCX, JPG, PNG</div>
                                ...
                                <div class="appointment-grid">
                                    ...
                                    <div class="appointment-info">
                                        ...
                                        <div class="info-content">
                                            ...
                                            <p>Consultation initiale d'une heure incluant l'analyse de votre dossier.</p>
                                        </div>
                                    </div>
                                    <div class="appointment-info">
                                        <div class="info-header">
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-primary btn-lg" id="submitBtn" aria-label="Envoyer la demande">
    ...
    <script>
        // Gestion du toggle pour le rendez-vous
        document.getElementById('appointmentToggle')?.addEventListener('click', function() {
            ...
            const isActive = toggleSlider.classList.toggle('active');
            ...
            document.getElementById('appointment_time').required = isActive;
            document.getElementById('paymentOnsite').required = isActive;
            document.getElementById('paymentOnline').required = isActive;
        });
        ...
        document.querySelectorAll('input[name="payment_method"]').forEach(function(radio) {
            radio.addEventListener('change', function() {
                ...
                stripeSection.style.display = this.value === 'online' ? 'block' : 'none';
            });
        });
    </script>
</body>
